...
@Mod("god")
public class GodMod {
	public static final Logger LOGGER = LogManager.getLogger(GodMod.class);
	public static final String MODID = "god";
	...
	public GodMod() {
		...
		GodModItems.REGISTRY.register(bus);
		GodModEntities.REGISTRY.register(bus);
