		...
		if (target(1)) {
			if (Minecraft.getInstance().player != null) {
				...
				if (Minecraft.getInstance().screen == null) {
					renderTexts(AbilityDisplayProcedure.execute(entity), 5, (float) (Minecraft.getInstance().getWindow().getGuiScaledHeight() - 20), 0, 0, 1,
							(int) ((AbilityDisplayProcedure.execute(entity)).length() > 9 ? 180 : 80) << 24 | 255 << 16 | 200 << 8 | 0, 6);
					id = (entity.getCapability(GodModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new GodModVariables.PlayerVariables())).move - 1;
					count = 1;
					for (int index0 = 0; index0 < 3; index0++) {
						...
						RenderSystem.setShaderTexture(0, new ResourceLocation(("god" + ":textures/" + "slot" + ".png")));
						renderTexture((float) (Minecraft.getInstance().getWindow().getGuiScaledWidth() * 0.1 + count * 20),
								(float) (Minecraft.getInstance().getWindow().getGuiScaledHeight() - Minecraft.getInstance().getWindow().getGuiScaledHeight() * 0.2), (float) (count == 0 ? 0 : -1), (float) (5 * count), (float) (count == 0 ? 0.8 : 0.6),
								(int) (count == 0 ? 255 : 180) << 24 | 255 << 16 | (int) (count == 0 ? 255 : 180) << 8 | 150, 4);
						texture = (((entity.getCapability(GodModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new GodModVariables.PlayerVariables())).abilityselect).getOrCreateTag().getString(("skill" + id))).toLowerCase().replace(" ", "_");
						if (!((texture).equals("none") || (texture).equals(""))) {
							RenderSystem.setShaderTexture(0, new ResourceLocation(("god" + ":textures/" + texture + ".png")));
							renderTexture((float) (Minecraft.getInstance().getWindow().getGuiScaledWidth() * 0.1 + count * 20),
									(float) (Minecraft.getInstance().getWindow().getGuiScaledHeight() - Minecraft.getInstance().getWindow().getGuiScaledHeight() * 0.2), (float) (count == 0 ? 0 : -1), (float) (5 * count),
									(float) (count == 0 ? 0.38 : 0.25), (int) (count == 0 ? 200 : 180) << 24 | (int) (count == 0 ? 255 : 180) << 16 | (int) (count == 0 ? 255 : 180) << 8 | (int) (count == 0 ? 255 : 180), 4);
						}
						id = id + 1;
						count = count - 1;
					}
