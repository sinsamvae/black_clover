...
public class GodModEntities {
	...
	public static final RegistryObject<EntityType<WindBladeEntity>> WIND_BLADE = register("wind_blade",
			EntityType.Builder.<WindBladeEntity>of(WindBladeEntity::new, MobCategory.MISC).setCustomClientFactory(WindBladeEntity::new).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).sized(0.3f, 0.4f));
