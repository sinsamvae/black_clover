...
public class Menu4ButtonMessage {
	private final int buttonID, x, y, z;
	private HashMap<String, String> textstate;

	public Menu4ButtonMessage(FriendlyByteBuf buffer) {
	...
	public Menu4ButtonMessage(int buttonID, int x, int y, int z, HashMap<String, String> textstate) {
	...
	public static void buffer(Menu4ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(Menu4ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z, HashMap<String, String> textstate) {
		...
		HashMap guistate = Menu4Menu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		GodMod.addNetworkMessage(Menu4ButtonMessage.class, Menu4ButtonMessage::buffer, Menu4ButtonMessage::new, Menu4ButtonMessage::handler);
	}
