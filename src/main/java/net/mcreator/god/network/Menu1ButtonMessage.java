...
public class Menu1ButtonMessage {
	private final int buttonID, x, y, z;
	private HashMap<String, String> textstate;

	public Menu1ButtonMessage(FriendlyByteBuf buffer) {
	...
	public Menu1ButtonMessage(int buttonID, int x, int y, int z, HashMap<String, String> textstate) {
	...
	public static void buffer(Menu1ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(Menu1ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z, HashMap<String, String> textstate) {
		...
		HashMap guistate = Menu1Menu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		GodMod.addNetworkMessage(Menu1ButtonMessage.class, Menu1ButtonMessage::buffer, Menu1ButtonMessage::new, Menu1ButtonMessage::handler);
	}
