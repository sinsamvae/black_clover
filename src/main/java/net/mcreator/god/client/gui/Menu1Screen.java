...
import net.mcreator.god.procedures.ReturnKIngdomProcedure;
import net.mcreator.god.procedures.ReturnClassProcedure;
import net.mcreator.god.procedures.ModelProcedure;
import net.mcreator.god.network.Menu1ButtonMessage;
...
public class Menu1Screen extends AbstractContainerScreen<Menu1Menu> implements WidgetScreen {
	private final static HashMap<String, Object> guistate = Menu1Menu.guistate;
	...
	public Menu1Screen(Menu1Menu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("god:textures/screens/menu_1.png");
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (ModelProcedure.execute(entity) instanceof LivingEntity livingEntity) {
			InventoryScreen.renderEntityInInventoryFollowsAngle(guiGraphics, this.leftPos + 66, this.topPos + 123, 50, 1.5f + (float) Math.atan((this.leftPos + 66 - mouseX) / 40.0), (float) Math.atan((this.topPos + 74 - mouseY) / 40.0),
					livingEntity);
		}
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("god:textures/screens/blankhold.png"), this.leftPos + -82, this.topPos + 160, 0, 0, 20, 20, 20, 20);
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font,
				...
				ReturnKIngdomProcedure.execute(entity), -109, 97, -13421773, false);
		guiGraphics.drawString(this.font,

				ReturnClassProcedure.execute(entity), -109, 115, -12829636, false);
	}
	...
	public void init() {
		...
		imagebutton_blank = new ImageButton(this.leftPos + -82, this.topPos + 160, 20, 20, 0, 0, 20, new ResourceLocation("god:textures/screens/atlas/imagebutton_blank.png"), 20, 40, e -> {
			if (true) {
				GodMod.PACKET_HANDLER.sendToServer(new Menu1ButtonMessage(0, x, y, z, textstate));
				Menu1ButtonMessage.handleButtonAction(entity, 0, x, y, z, textstate);
			}
		});
		...
		imagebutton_blank1 = new ImageButton(this.leftPos + -46, this.topPos + 160, 20, 20, 0, 0, 20, new ResourceLocation("god:textures/screens/atlas/imagebutton_blank1.png"), 20, 40, e -> {
			if (true) {
				GodMod.PACKET_HANDLER.sendToServer(new Menu1ButtonMessage(1, x, y, z, textstate));
				Menu1ButtonMessage.handleButtonAction(entity, 1, x, y, z, textstate);
			}
		});
		...
		imagebutton_blank3 = new ImageButton(this.leftPos + 26, this.topPos + 160, 20, 20, 0, 0, 20, new ResourceLocation("god:textures/screens/atlas/imagebutton_blank3.png"), 20, 40, e -> {
			if (true) {
				GodMod.PACKET_HANDLER.sendToServer(new Menu1ButtonMessage(2, x, y, z, textstate));
				Menu1ButtonMessage.handleButtonAction(entity, 2, x, y, z, textstate);
			}
		});
		...
		imagebutton_blank4 = new ImageButton(this.leftPos + -10, this.topPos + 160, 20, 20, 0, 0, 20, new ResourceLocation("god:textures/screens/atlas/imagebutton_blank4.png"), 20, 40, e -> {
			if (true) {
				GodMod.PACKET_HANDLER.sendToServer(new Menu1ButtonMessage(3, x, y, z, textstate));
				Menu1ButtonMessage.handleButtonAction(entity, 3, x, y, z, textstate);
			}
		});
		...
		imagebutton_blank2 = new ImageButton(this.leftPos + 62, this.topPos + 160, 20, 20, 0, 0, 20, new ResourceLocation("god:textures/screens/atlas/imagebutton_blank2.png"), 20, 40, e -> {
			if (true) {
				GodMod.PACKET_HANDLER.sendToServer(new Menu1ButtonMessage(4, x, y, z, textstate));
				Menu1ButtonMessage.handleButtonAction(entity, 4, x, y, z, textstate);
			}
		});
