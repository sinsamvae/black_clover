...
public class ModelHellFire5<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("god", "model_hell_fire_5"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = bone.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 24).addBox(-4.3045F, -1.1739F, -0.9044F, 5.0F, 2.0F, 2.0F, new CubeDeformation(-0.35F)),
				PartPose.offsetAndRotation(19.2713F, -2.5313F, -2.8852F, -0.7333F, -0.639F, 0.493F));
		PartDefinition cube_r2 = bone.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(75, 13).addBox(-0.9682F, -1.1739F, -0.931F, 8.0F, 2.0F, 2.0F, new CubeDeformation(-0.35F)),
				PartPose.offsetAndRotation(10.9548F, -5.4732F, -7.5031F, -0.6229F, -0.4F, 0.2727F));
		PartDefinition cube_r3 = bone.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(0, 24).addBox(-2.5635F, -1.1739F, -0.8565F, 5.0F, 2.0F, 2.0F, new CubeDeformation(-0.35F)),
		...
		PartDefinition cube_r5 = bone.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(0, 24).addBox(-2.7444F, -1.1739F, -0.9409F, 5.0F, 2.0F, 2.0F, new CubeDeformation(-0.35F)),
		...
		PartDefinition cube_r9 = bone.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(0, 24).addBox(-2.8365F, -1.1739F, -0.8565F, 5.0F, 2.0F, 2.0F, new CubeDeformation(-0.35F)),
				PartPose.offsetAndRotation(-9.9929F, -4.4045F, -6.218F, -1.0299F, -0.8934F, 0.914F));
		PartDefinition cube_r10 = bone.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(75, 13).addBox(-7.4318F, -1.1739F, -0.931F, 8.0F, 2.0F, 2.0F, new CubeDeformation(-0.35F)),
				PartPose.offsetAndRotation(-10.7734F, -5.2232F, -7.5031F, -0.6229F, 0.4F, -0.2727F));
		PartDefinition cube_r11 = bone.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(0, 24).addBox(-1.0955F, -1.1739F, -0.9044F, 5.0F, 2.0F, 2.0F, new CubeDeformation(-0.35F)),
				PartPose.offsetAndRotation(-19.0898F, -2.2813F, -2.8852F, -0.7333F, 0.639F, -0.493F));
		PartDefinition cube_r12 = bone.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(0, 24).addBox(-2.6556F, -1.1739F, -0.9409F, 5.0F, 2.0F, 2.0F, new CubeDeformation(-0.35F)),
		...
		PartDefinition cube_r20 = bone.addOrReplaceChild("cube_r20", CubeListBuilder.create().texOffs(59, 55).addBox(-3.988F, -4.0414F, -3.1581F, 4.0F, 4.0F, 7.0F, new CubeDeformation(-0.6F)),
				PartPose.offsetAndRotation(-1.9758F, -4.0814F, -4.3595F, 0.4215F, -0.3614F, -0.1572F));
		...
		PartDefinition cube_r25 = bone.addOrReplaceChild("cube_r25", CubeListBuilder.create().texOffs(0, 0).addBox(-4.5F, 0.6633F, 7.2874F, 9.0F, 0.0F, 15.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r26 = bone.addOrReplaceChild("cube_r26",
				CubeListBuilder.create().texOffs(0, 16).addBox(-4.5F, 3.0531F, 2.8121F, 9.0F, 0.0F, 15.0F, new CubeDeformation(0.0F)).texOffs(76, 19).addBox(-1.6F, 1.3167F, 1.8371F, 3.0F, 3.0F, 6.0F, new CubeDeformation(-0.05F)),
