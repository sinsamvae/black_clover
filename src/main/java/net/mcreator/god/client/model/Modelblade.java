...
public class Modelblade<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("god", "modelblade"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r3 = group.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(0, 0).addBox(-1.5F, -0.6F, 0.0F, 0.2F, 0.6F, 0.2F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.8863F, -13.2617F, 1.4F, 0.0F, 0.0F, 0.384F));
		PartDefinition cube_r4 = group.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(0, 0).addBox(1.3F, -0.6F, 0.0F, 0.2F, 0.6F, 0.2F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.0863F, -13.2617F, 1.4F, 0.0F, 0.0F, -0.384F));
		PartDefinition cube_r5 = group.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(4, 3).addBox(-1.9F, -0.6F, 0.0F, 0.6F, 0.6F, 0.2F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.3863F, -12.4617F, 1.4F, 0.0F, 0.0F, 0.733F));
		PartDefinition cube_r6 = group.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(0, 0).addBox(-1.9F, -1.9F, 0.0F, 0.3F, 0.6F, 0.1F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.6F, -12.7F, 1.4F, 0.0001F, 0.0249F, -0.4182F));
		PartDefinition cube_r7 = group.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(0, 0).addBox(-1.5F, -0.9F, 0.0F, 0.2F, 0.9F, 0.2F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.0535F, -14.9154F, 1.4F, 0.0F, 0.0F, -0.4887F));
		PartDefinition cube_r8 = group.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(0, 0).addBox(-1.4F, -1.8F, 0.1F, 0.3F, 0.5F, 0.1F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.9F, -11.5F, 1.3F, 0.0F, 0.0F, 0.4538F));
