...
public class ModelHellFire5<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = bone.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 24).addBox(-4.3045F, -1.1739F, -0.9044F, 5.0F, 2.0F, 2.0F,
						new CubeDeformation(-0.35F)),
				PartPose.offsetAndRotation(19.2713F, -2.5313F, -2.8852F, -0.7333F, -0.639F, 0.493F));

		PartDefinition cube_r2 = bone.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(75, 13).addBox(-0.9682F, -1.1739F, -0.931F, 8.0F, 2.0F, 2.0F,
						new CubeDeformation(-0.35F)),
				PartPose.offsetAndRotation(10.9548F, -5.4732F, -7.5031F, -0.6229F, -0.4F, 0.2727F));

		PartDefinition cube_r3 = bone.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 24).addBox(-2.5635F, -1.1739F, -0.8565F, 5.0F, 2.0F, 2.0F,
						new CubeDeformation(-0.35F)),
		...
		PartDefinition cube_r5 = bone.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(0, 24).addBox(-2.7444F, -1.1739F, -0.9409F, 5.0F, 2.0F, 2.0F,
						new CubeDeformation(-0.35F)),
		...
		PartDefinition cube_r9 = bone.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(0, 24).addBox(-2.8365F, -1.1739F, -0.8565F, 5.0F, 2.0F, 2.0F,
						new CubeDeformation(-0.35F)),
		...
		PartDefinition cube_r10 = bone.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(75, 13).addBox(-7.4318F, -1.1739F, -0.931F, 8.0F, 2.0F, 2.0F,
						new CubeDeformation(-0.35F)),
		...
		PartDefinition cube_r11 = bone.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(0, 24).addBox(-1.0955F, -1.1739F, -0.9044F, 5.0F, 2.0F, 2.0F,
						new CubeDeformation(-0.35F)),
		...
		PartDefinition cube_r12 = bone.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(0, 24).addBox(-2.6556F, -1.1739F, -0.9409F, 5.0F, 2.0F, 2.0F,
						new CubeDeformation(-0.35F)),
		...
		PartDefinition cube_r25 = bone.addOrReplaceChild("cube_r25",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.5F, 0.6633F, 7.2874F, 9.0F, 0.0F, 15.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r26 = bone.addOrReplaceChild("cube_r26",
				CubeListBuilder.create().texOffs(0, 16)
						...
						.addBox(-1.6F, 1.3167F, 1.8371F, 3.0F, 3.0F, 6.0F, new CubeDeformation(-0.05F)),
